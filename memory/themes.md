...
| 方向 | 品类 | 06→07 | 变化 |
|---|---|---|---|
| ↑ | 电脑/电子/科技 | 429万→591万 | **+37.9%**,代表产品清一色 AI 生成工具 |
| ↑ | 游戏 | 280万→369万 | +31.9% |
| ↓ | 餐饮外卖 | 592万→426万 | -28.1% |
| ↓ | **虚拟主机/域名** | 180万→151万 | **-16.2%** —— 建站工具链的上游需求在缩,与本项目相关 |

**最值得记的一条**:AI 工具的付款意图仍在**加速**(+37.9%),与"AI 已经卷完了"的流行判断相反。
但注意这是**付款意图**不是收入,且 [risks.md CPC 条目](risks.md) 已记录 AI 工具站品类 CPC 系统性偏低。

### 候选(均未开站,不构成推荐)

| 候选 | 证据 | 相关度 |
|---|---|---|
| **outrank.so** | Stripe 位次 957→307,引荐 4.8k→17.9k,整站 16.6 万 growing | **与自有四站技能栈重叠最高**——SEO 内容生成 SaaS,即便不做,看它怎么把 SEO 流量转成付费也直接有用 |
| **forgegui.com** | 位次 41→16,引荐 26.4 万,整站 6 个月 3.8k→63.4 万,域龄 **171 天** | 唯一「大位次+大流量+极年轻」三合一 |
| **trustmrr.com** | Stripe + LS **双平台**同向上升,整站 76万→92万,域龄 299 天 | 唯一跨平台信号 |
| adspirer.ai | 整站 6 个月 64 倍,域龄 374 天,sustained_growth | 踩在最热品类上 |
| app.tryatria.com | Stripe+Paddle 双平台,Paddle 上是新面孔 | 新面孔 = 刚开始正经收订阅 |
...
- **下一步**:⛔ 不扩大候选池。按 [payment-growth skill](../.claude/skills/payment-growth/SKILL.md) 的硬约束,
  一轮最多留 3-5 个。当前主线是 partfit3d A 路线(时间盒 09-08),**本轮候选一律挂起,不启动新方向**。
