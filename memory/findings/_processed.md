...
防重的真相之源。每次摄入新文章前,先在这里查一下哈希是否已存在;摄入完成后追加一行。

| 摄入时间(UTC+8) | raw 文件路径 | sha256(前 12 位) | 处理结果 | finding 链接 |
|---|---|---|---|---|
| 2026-04-27 21:40 | (URL 来源) https://avbdmra8fx.feishu.cn/docx/GTFQdNOFLosP3VxCuDqc6UOTnVg | docx-id:GTFQdNOFLo | kept | [youtube-ai-faceless-channel-sop.md](youtube-ai-faceless-channel-sop.md) |
| 2026-04-27 22:30 | raw/用好 AI 跟上时代.md | d0d9350dfe45 | kept | [2026-04-do-it-yourself-mindset.md](2026-04-do-it-yourself-mindset.md) |
...
| 2026-04-29 | raw/热词建站,日入过万.md | 3f454d1f4aa6 | kept | [2026-04-hot-keyword-quick-site.md](2026-04-hot-keyword-quick-site.md) |
...
| 2026-05-19 15:10 | (URL 来源) https://my.feishu.cn/wiki/Y0rpwvIeoiLn0lk679PcWOKCnSf | wiki-id:Y0rpwvIeoi | kept | [2026-05-seo-site-demand-conversion-chain.md](2026-05-seo-site-demand-conversion-chain.md) |
| 2026-05-19 19:32 | (URL 来源) https://bcn5ot9wwnew.feishu.cn/wiki/JB92wcXppiWZfdk1euncasBGnKg | wiki-id:JB92wcXppi | kept | [2026-05-x-ai-media-cold-start.md](2026-05-x-ai-media-cold-start.md) |

> 处理结果取值:`kept` (已写 finding) / `dropped` (噪音过滤掉) / `flagged` (有风险已记入 risks.md)。
> 被丢弃的文章也要登记,避免反复处理同一篇。
> URL 来源(非 raw/ 文件)用 docx/wiki token 前 10 位作为 sha 列的替代标识,保证幂等。
